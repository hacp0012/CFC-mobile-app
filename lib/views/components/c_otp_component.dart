...
class _COtpComponentState extends State<COtpComponent> {
  ...
  Widget build(BuildContext context) {
    switch (otpState) {
      ...
      default:
        return Animate(
          effects: [FadeEffect(duration: 500.ms), const SlideEffect(curve: Curves.easeInOut, begin: Offset(0.0, 0.5))],
          child: OTPTextFieldV2(
            ...
            fieldWidth: CConstants.GOLDEN_SIZE * 5,
            keyboardType: TextInputType.number,
            outlineBorderRadius: CConstants.DEFAULT_RADIUS / 2,
